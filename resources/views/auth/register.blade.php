...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8" style="margin-right: 8rem">

            <div class="form-group" style="padding-left: 7.3rem;">
                <h3 class="text-center" style="padding-top: 6rem;">Cadastrar nova conta</h3>
            </div>
